...
public class VerticalActivity extends AppCompatActivity {
    ...
    private void initRecyclerView() {
        ...
        allList.add(new VerticalBean("0", "< GridView >+上拉下拉+下载进度条"));
        allList.add(new VerticalBean("1", "< 横纵向结合 >+上拉下拉+下载进度条+局部更新"));
        allList.add(new VerticalBean("2", "GridView+上拉下拉+< Delete >+Report"));
        allList.add(new VerticalBean("3", "< 瀑布流 >+上拉下拉+下载进度条"));
