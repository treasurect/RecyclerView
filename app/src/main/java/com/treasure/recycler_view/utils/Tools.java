 ...
 *
 */
package com.treasure.recycler_view.utils;
...
//        tintManager.setStatusBarTintResource(R.color.color_black_toolbar);// 状态栏无背景
//    }
    ...
    public static String saveBitmapToSD(Context context, Bitmap bitmap, String name, int type) {
        String absolutePath = context.getExternalFilesDir(null).getAbsolutePath();
        File file = new File(absolutePath + "/" + name + ".png");
        try {
            if (!file.exists()) {
...
//    }
    ...
    //属性动画 ： scale
    public static void setScaleAnimation(View view, float scaleStartX, float scaleEndX, float scaleStartY, float scaleEndY, int duration) {
        ObjectAnimator scaleX = ObjectAnimator.ofFloat(view, "scaleX", scaleStartX, 1f, scaleEndX);
        ObjectAnimator scaleY = ObjectAnimator.ofFloat(view, "scaleY", scaleStartY, 1f, scaleEndY);
        AnimatorSet animatorSet = new AnimatorSet();
