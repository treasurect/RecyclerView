...
public class VideoPlayerView extends RelativeLayout {
    ...
    private void initView() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            videoView.setOutlineProvider(new TextureVideoViewOutlineProvider(context, Tools.dip2px(context, 6)));
...
//            Log.i(TAG,"percent:"+percent);
    ...
    private SnapHelperBean info;
    public void setPlayData(SnapHelperBean info) {
        this.info = info;
    }
}
